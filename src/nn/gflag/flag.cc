...
DEFINE_string(bias_feature, "1,2,3,4,18,25,26", "lengths of lookup tables");
DEFINE_string(lookup_table_param,"150000:150000", "");
...
DEFINE_string(nn_layer_param, "1000:100:2", "layer size of nn");
